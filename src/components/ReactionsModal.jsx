  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative z-50 w-full max-w-sm rounded-2xl border border-white/40 bg-white/40 bg-clip-padding p-4 shadow-2xl backdrop-blur-xl">
        {/* Tabs */}
        <div className="mb-3 flex items-center gap-2 overflow-x-auto pb-1">
          <button
            type="button"
            onClick={() => setActiveFilter(ALL_FILTER)}
            className={`flex items-center gap-2 rounded-full px-3 py-1 text-xs font-medium shadow-sm focus-visible:outline-none focus-visible:ring-2 whitespace-nowrap ${
          ...
          {reactionEntries.map(([emoji, info]) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium shadow-sm focus-visible:outline-none focus-visible:ring-2 whitespace-nowrap ${
                  isActive
                    ? "bg-gray-900 text-white focus-visible:ring-gray-500"
                    : "bg-gray-100 text-gray-700 focus-visible:ring-gray-300"
                }`}
