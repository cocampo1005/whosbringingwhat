...
export default function Tooltip({ content, ariaLabel, children }) {
      ...
      {visible && (
        ...
        >
          <div className="relative w-72 rounded-md border border-gray-300 bg-white px-3 py-2 text-xs text-black shadow-lg">
            {content}
            <div className="absolute right-[4px] top-full h-2 w-2 -translate-y-1/2 rotate-45 bg-white shadow-lg" />
          </div>
        </div>
      )}
    </div>
